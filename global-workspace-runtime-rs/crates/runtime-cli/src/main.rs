...
fn cmd_proof(args: &[String]) {
    ...
    let proof_hash_1 = evidence_vault
        ...
        .unwrap_or_default();
    let _ = run.log.append_with_origin(
    ...
    let _ = run.log.append_with_origin(
        EventOrigin::ProofHarness,
        RuntimeEvent::ToolExecutionBlocked {
    ...
    write_integration_report(
        ...
        serde_json::json!({
            ...
            "basis_item_fields": ["claim_id", "subject", "predicate", "object", "confidence", "evidence_ids"],
            "confidence_is_f64": true,
